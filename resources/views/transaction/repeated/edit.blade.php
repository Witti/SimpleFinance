        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/transaction/repeated/update/' . $transaction->id) }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group{{ $errors->has('accountid') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::select('accountid', $accounts, $transaction->account_id,['class' => 'form-control']) !!}
                        ...
                        <div class="form-group{{ $errors->has('transactiondate') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group date">
                                    <input type="text" class="form-control" name="startdate" value="{{ $transaction->startdate }}" data-date-format="dd.mm.yyyy"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                                </div>
                        ...
                        <div class="form-group{{ $errors->has('category_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-1">
                                {!! Form::select('rmode', ['day' => 'day','week' => 'week','month' => 'month','year' => 'year'], $transaction->rmode,['class' => 'form-control']) !!}
                                @if ($errors->has('rmode'))
                                    <span class="help-block">
                        ...
                        <div class="transfer-account-fg form-group{{ $errors->has('transfer_account_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::select('transfer_account_id', $accounts, $transaction->transfer_account_id,['class' => 'selectpicker']) !!}
